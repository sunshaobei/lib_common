package com.sunsh.baselibrary.widgets.pickview.citypickerview;
...
import com.sunsh.baselibrary.widgets.pickview.citypickerview.Interface.OnCityItemClickListener;
...
import com.sunsh.baselibrary.widgets.pickview.widget.CanShow;
import com.sunsh.baselibrary.widgets.pickview.widget.wheel.OnWheelChangedListener;
...
import com.sunsh.baselibrary.widgets.pickview.citypickerview.citywheel.CityConfig;
import com.sunsh.baselibrary.widgets.pickview.citypickerview.citywheel.CityParseHelper;
    ...
    private void initCityPickerPopwindow() {
        ...
        popwindow.setOnDismissListener(() -> {
            ...
            if (config.isShowBackground()) {
                PickViewUtils.setBackgroundAlpha(context, 1.0f);
            }
        });
        /**
         * 设置标题背景颜色
