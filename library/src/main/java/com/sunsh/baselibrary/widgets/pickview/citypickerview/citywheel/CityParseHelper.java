package com.sunsh.baselibrary.widgets.pickview.citypickerview.citywheel;

import android.content.Context;

import com.sunsh.baselibrary.widgets.pickview.citypickerview.PickViewConstant;
...
public class CityParseHelper {
    ...
    public void initData(Context context) {
        ...
        String cityJson = PickViewUtils.getJson(context, PickViewConstant.CITY_DATA);
